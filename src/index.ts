...
import { Blockchain, BlockOp, Miner, FixedPoint } from '@hyper-hyper-space/pulsar';
...
import { WorkerThreadVDF } from './WorkerThreadVDF';
...
async function main() {
    ...
    if (args.mode === 'wallet') {
        ...
        let miner = new Miner(blockchain, resources.config.id, WorkerThreadVDF);
